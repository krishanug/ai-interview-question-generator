...
public class PromptBuilderServiceImpl implements PromptBuilderService {
    ...
    public String buildRegenerationPrompt(
        ...
        return """
                You are a senior backend interviewer.
                Improve the following weak interview questions for topic: %s.
                Difficulty: %s.
                ...
                Rules:
                - Return exactly %d improved and distinct questions.
                - Keep a backend engineering focus.
                - Prefer practical and scenario-based interview questions.
                - Avoid purely theoretical questions.
                - Avoid duplicate or near-duplicate questions.
                ...
                request.getTopic(),
                request.getDifficulty().name(),
                formatWeakQuestions(weakQuestions),
                requiredCount,
                difficultyGuideline,
                requiredCount
        );
    ...
    private String formatWeakQuestions(List<String> weakQuestions) {
        StringBuilder builder = new StringBuilder();
        for (int index = 0; index < weakQuestions.size(); index++) {
            builder.append(index + 1).append(". ").append(weakQuestions.get(index)).append("\n");
        }
